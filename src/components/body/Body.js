    ...
    return (
        <div>
            ...
            <div className={`${styles.fundraw} ${"d-flex flex-column align-items-center mx-5 mb-5"}`}>
                <video className={`${styles.video} ${"mb-4"}`} loop autoPlay muted playsInline>
            ...
            <div className={`${styles.card} ${"card text-center bg-transparent border border-dark border-2 rounded-4 my-5 mx-4"}`}>
